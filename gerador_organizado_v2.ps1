...
foreach ($vid in $videos) {
    ...
    [System.IO.File]::WriteAllText("$PWD\temp_task.json", $json, (New-Object System.Text.UTF8Encoding($False)))
    
    uv run python cli.py --batch-file temp_task.json --bgm-type none
